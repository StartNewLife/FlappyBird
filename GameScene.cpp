...
bool GameScene::init()
{
	...
	CocosDenshion::SimpleAudioEngine::getInstance()->playBackgroundMusic("Sound / LoL - Electro Mix 1 Hour.mp3");
...
bool GameScene::onContactBegin(cocos2d::PhysicsContact &contact)
{
	...
	{
		int SoundID_3 = CocosDenshion::SimpleAudioEngine::getInstance()->playEffect("Sound/Hit.wav");
		...
		|| (BIRD_COLLISION_BITMASK == b->getCollisionBitmask() && POINT_COLLISION_BITMASK == a->getCollisionBitmask()))
	{
		...
		int SoundID_2 = CocosDenshion::SimpleAudioEngine::getInstance()->playEffect("Sound/Point.wav");
